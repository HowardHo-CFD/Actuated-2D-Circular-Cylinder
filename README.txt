This is my case setup for simulating flow over a 2D circular cylinder with wall-resolved LES at Re_D=3,900. The caes setup also includes the UDF for the 5 circular nozzle SJAs control parameters under 0/U.
...
- Brief comment on the results - 5 SJAs is not enough, debug with 1 then 5 SJAs, but start with 10 for the serious cases.
